...
EditProjectGlobsDlg::EditProjectGlobsDlg(const cbProject* prj, const ProjectGlob& glob, wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size) : m_GlobObj(glob)
{
	...
	StaticText1 = new wxStaticText(StaticBoxSizer1->GetStaticBox(), wxID_ANY, _("Path:"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
	BoxSizer1->Add(StaticText1, 0, wxALIGN_CENTER_VERTICAL, 5);
	txtPath = new wxTextCtrl(StaticBoxSizer1->GetStaticBox(), ID_TEXTPATH, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTPATH"));
	BoxSizer1->Add(txtPath, 1, wxLEFT|wxALIGN_CENTER_VERTICAL, 5);
	btnBrowse = new wxBitmapButton(StaticBoxSizer1->GetStaticBox(), ID_BTN_BROWSE, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_FILE_OPEN")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BTN_BROWSE"));
	BoxSizer1->Add(btnBrowse, 0, wxALIGN_CENTER_VERTICAL, 5);
	btnOther = new wxBitmapButton(StaticBoxSizer1->GetStaticBox(), ID_BTN_OTHER, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_EXECUTABLE_FILE")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BTN_OTHER"));
	BoxSizer1->Add(btnOther, 0, wxALIGN_CENTER_VERTICAL, 5);
	StaticBoxSizer1->Add(BoxSizer1, 1, wxLEFT|wxRIGHT|wxEXPAND, 5);
	BoxSizer2 = new wxBoxSizer(wxHORIZONTAL);
	StaticText2 = new wxStaticText(StaticBoxSizer1->GetStaticBox(), wxID_ANY, _("Wildcard: "), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
	BoxSizer2->Add(StaticText2, 0, wxALIGN_CENTER_VERTICAL, 5);
	txtWildcart = new wxTextCtrl(StaticBoxSizer1->GetStaticBox(), ID_TXT_WILDCART, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TXT_WILDCART"));
	BoxSizer2->Add(txtWildcart, 1, wxALIGN_CENTER_VERTICAL, 5);
	chkRecursive = new wxCheckBox(StaticBoxSizer1->GetStaticBox(), ID_CHECK_RECURSIVE, _("Recursive"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECK_RECURSIVE"));
	...
	StaticText3 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), ID_STATICTEXT1, _("Targets:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
	BoxSizer7->Add(StaticText3, 0, wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer7->Add(-1,-1,1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
	chkAllNone = new wxCheckBox(StaticBoxSizer2->GetStaticBox(), ID_CHK_ALL_NONE, _("All/None"), wxDefaultPosition, wxDefaultSize, wxCHK_3STATE, wxDefaultValidator, _T("ID_CHK_ALL_NONE"));
	chkAllNone->SetValue(false);
	BoxSizer7->Add(chkAllNone, 0, wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer4->Add(BoxSizer7, 0, wxEXPAND, 5);
	lstTargets = new wxCheckListBox(StaticBoxSizer2->GetStaticBox(), ID_LST_TARGETS, wxDefaultPosition, wxDefaultSize, 0, 0, 0, wxDefaultValidator, _T("ID_LST_TARGETS"));
	BoxSizer4->Add(lstTargets, 1, wxEXPAND, 5);
	StaticBoxSizer2->Add(BoxSizer4, 1, wxTOP|wxLEFT|wxRIGHT|wxEXPAND, 5);
	BoxSizer6 = new wxBoxSizer(wxHORIZONTAL);
	chkAddToProject = new wxCheckBox(StaticBoxSizer2->GetStaticBox(), ID_CHECK_ADD_TO_PROJECT, _("Add files to project"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECK_ADD_TO_PROJECT"));
	chkAddToProject->SetValue(false);
	BoxSizer6->Add(chkAddToProject, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5);
