...
//(*IdInit(HexEditPanel)
const wxWindowID HexEditPanel::ID_STATICTEXT1 = wxNewId();
const wxWindowID HexEditPanel::ID_BUTTON10 = wxNewId();
const wxWindowID HexEditPanel::ID_BUTTON9 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICLINE2 = wxNewId();
const wxWindowID HexEditPanel::ID_BUTTON7 = wxNewId();
const wxWindowID HexEditPanel::ID_BUTTON4 = wxNewId();
const wxWindowID HexEditPanel::ID_BUTTON6 = wxNewId();
const wxWindowID HexEditPanel::ID_BUTTON5 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICLINE1 = wxNewId();
const wxWindowID HexEditPanel::ID_BUTTON1 = wxNewId();
const wxWindowID HexEditPanel::ID_BUTTON8 = wxNewId();
const wxWindowID HexEditPanel::ID_CHECKBOX1 = wxNewId();
const wxWindowID HexEditPanel::ID_PANEL1 = wxNewId();
const wxWindowID HexEditPanel::ID_SCROLLBAR1 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT2 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT3 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT4 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT5 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT6 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT7 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT8 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT9 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT10 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT11 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT12 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT13 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT14 = wxNewId();
const wxWindowID HexEditPanel::ID_TEXTCTRL1 = wxNewId();
const wxWindowID HexEditPanel::ID_BUTTON3 = wxNewId();
const wxWindowID HexEditPanel::ID_BUTTON2 = wxNewId();
const wxWindowID HexEditPanel::ID_STATICTEXT15 = wxNewId();
const wxWindowID HexEditPanel::ID_TIMER1 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM2 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM1 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM3 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM4 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM5 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM6 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM7 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM8 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM9 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM11 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM12 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM13 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM14 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM15 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM16 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM17 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM18 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM32 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM10 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM20 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM21 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM22 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM23 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM24 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM25 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM26 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM27 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM19 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM29 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM30 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM31 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM33 = wxNewId();
const wxWindowID HexEditPanel::ID_MENUITEM28 = wxNewId();
//*)
    ...
    , m_ColsMode( CM_ANY )
{
    ...
    */
    ...
    m_ByteVal = new wxStaticText(this, ID_STATICTEXT3, _T("-9999999999"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
    ...
    m_WordVal = new wxStaticText(this, ID_STATICTEXT5, _T("-9999999999"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
    ...
    m_DwordVal = new wxStaticText(this, ID_STATICTEXT7, _T("-9999999999"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT7"));
    ...
    m_FloatVal = new wxStaticText(this, ID_STATICTEXT9, _T("-9999999999"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT9"));
    ...
    m_DoubleVal = new wxStaticText(this, ID_STATICTEXT11, _T("-9999999999"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT11"));
    ...
    m_LDoubleVal = new wxStaticText(this, ID_STATICTEXT13, _T("-9999999999"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT13"));
    ...
    m_ExpressionVal = new wxStaticText(this, ID_STATICTEXT15, _T("-9999999999"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT15"));
    ...
    MenuItem11 = new wxMenuItem(MenuItem10, ID_MENUITEM11, _T("1"), wxEmptyString, wxITEM_NORMAL);
    MenuItem10->Append(MenuItem11);
    MenuItem12 = new wxMenuItem(MenuItem10, ID_MENUITEM12, _T("2"), wxEmptyString, wxITEM_NORMAL);
    MenuItem10->Append(MenuItem12);
    MenuItem13 = new wxMenuItem(MenuItem10, ID_MENUITEM13, _T("3"), wxEmptyString, wxITEM_NORMAL);
    MenuItem10->Append(MenuItem13);
    MenuItem14 = new wxMenuItem(MenuItem10, ID_MENUITEM14, _T("4"), wxEmptyString, wxITEM_NORMAL);
    MenuItem10->Append(MenuItem14);
    MenuItem15 = new wxMenuItem(MenuItem10, ID_MENUITEM15, _T("5"), wxEmptyString, wxITEM_NORMAL);
    MenuItem10->Append(MenuItem15);
    MenuItem16 = new wxMenuItem(MenuItem10, ID_MENUITEM16, _T("6"), wxEmptyString, wxITEM_NORMAL);
    MenuItem10->Append(MenuItem16);
    MenuItem17 = new wxMenuItem(MenuItem10, ID_MENUITEM17, _T("7"), wxEmptyString, wxITEM_NORMAL);
    MenuItem10->Append(MenuItem17);
    MenuItem18 = new wxMenuItem(MenuItem10, ID_MENUITEM18, _T("8"), wxEmptyString, wxITEM_NORMAL);
    ...
    MenuItem20 = new wxMenuItem(MenuItem19, ID_MENUITEM20, _T("2"), wxEmptyString, wxITEM_NORMAL);
    MenuItem19->Append(MenuItem20);
    MenuItem21 = new wxMenuItem(MenuItem19, ID_MENUITEM21, _T("3"), wxEmptyString, wxITEM_NORMAL);
    MenuItem19->Append(MenuItem21);
    MenuItem22 = new wxMenuItem(MenuItem19, ID_MENUITEM22, _T("4"), wxEmptyString, wxITEM_NORMAL);
    MenuItem19->Append(MenuItem22);
    MenuItem23 = new wxMenuItem(MenuItem19, ID_MENUITEM23, _T("5"), wxEmptyString, wxITEM_NORMAL);
    MenuItem19->Append(MenuItem23);
    MenuItem24 = new wxMenuItem(MenuItem19, ID_MENUITEM24, _T("6"), wxEmptyString, wxITEM_NORMAL);
    MenuItem19->Append(MenuItem24);
    MenuItem25 = new wxMenuItem(MenuItem19, ID_MENUITEM25, _T("7"), wxEmptyString, wxITEM_NORMAL);
    MenuItem19->Append(MenuItem25);
    MenuItem26 = new wxMenuItem(MenuItem19, ID_MENUITEM26, _T("8"), wxEmptyString, wxITEM_NORMAL);
    ...
    MenuItem29 = new wxMenuItem(MenuItem28, ID_MENUITEM29, _T("2"), wxEmptyString, wxITEM_NORMAL);
    MenuItem28->Append(MenuItem29);
    MenuItem30 = new wxMenuItem(MenuItem28, ID_MENUITEM30, _T("4"), wxEmptyString, wxITEM_NORMAL);
    MenuItem28->Append(MenuItem30);
    MenuItem31 = new wxMenuItem(MenuItem28, ID_MENUITEM31, _T("8"), wxEmptyString, wxITEM_NORMAL);
    ...
    Connect(ID_BUTTON10,wxEVT_COMMAND_BUTTON_CLICKED,wxCommandEventHandler(HexEditPanel::OnButton6Click));
    Connect(ID_BUTTON9,wxEVT_COMMAND_BUTTON_CLICKED,wxCommandEventHandler(HexEditPanel::OnButton5Click));
    Connect(ID_BUTTON7,wxEVT_COMMAND_BUTTON_CLICKED,wxCommandEventHandler(HexEditPanel::Onm_ColsModeClick));
    Connect(ID_BUTTON4,wxEVT_COMMAND_BUTTON_CLICKED,wxCommandEventHandler(HexEditPanel::OnButton4Click));
    Connect(ID_BUTTON6,wxEVT_COMMAND_BUTTON_CLICKED,wxCommandEventHandler(HexEditPanel::Onm_BlockSizeClick));
    Connect(ID_BUTTON5,wxEVT_COMMAND_BUTTON_CLICKED,wxCommandEventHandler(HexEditPanel::Onm_EndianessClick));
    ...
    Connect(ID_SCROLLBAR1,wxEVT_SCROLL_LINEDOWN,wxScrollEventHandler(HexEditPanel::OnContentScroll));
    Connect(ID_SCROLLBAR1,wxEVT_SCROLL_PAGEUP,wxScrollEventHandler(HexEditPanel::OnContentScroll));
    Connect(ID_SCROLLBAR1,wxEVT_SCROLL_PAGEDOWN,wxScrollEventHandler(HexEditPanel::OnContentScroll));
    Connect(ID_SCROLLBAR1,wxEVT_SCROLL_THUMBTRACK,wxScrollEventHandler(HexEditPanel::OnContentScroll));
    Connect(ID_SCROLLBAR1,wxEVT_SCROLL_THUMBRELEASE,wxScrollEventHandler(HexEditPanel::OnContentScroll));
    Connect(ID_SCROLLBAR1,wxEVT_SCROLL_CHANGED,wxScrollEventHandler(HexEditPanel::OnContentScroll));
    Connect(ID_TEXTCTRL1,wxEVT_COMMAND_TEXT_UPDATED,wxCommandEventHandler(HexEditPanel::Onm_ExpressionText));
    Connect(ID_TEXTCTRL1,wxEVT_COMMAND_TEXT_ENTER,wxCommandEventHandler(HexEditPanel::OnExpressionTextEnter));
    Connect(ID_BUTTON3,wxEVT_COMMAND_BUTTON_CLICKED,wxCommandEventHandler(HexEditPanel::OnButton3Click1));
    Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,wxCommandEventHandler(HexEditPanel::OnButton2Click));
    Connect(ID_TIMER1,wxEVT_TIMER,wxTimerEventHandler(HexEditPanel::OnReparseTimerTrigger));
    Connect(ID_MENUITEM2,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetBaseBin));
    Connect(ID_MENUITEM1,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetBaseHex));
    Connect(ID_MENUITEM3,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetEndianessBig));
    Connect(ID_MENUITEM4,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetEndianessLittle));
    Connect(ID_MENUITEM5,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetBlockSize1));
    Connect(ID_MENUITEM6,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetBlockSize2));
    Connect(ID_MENUITEM7,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetBlockSize4));
    Connect(ID_MENUITEM8,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetBlockSize8));
    Connect(ID_MENUITEM9,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsMul1));
    Connect(ID_MENUITEM11,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsValue1));
    Connect(ID_MENUITEM12,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsValue2));
    Connect(ID_MENUITEM13,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsValue3));
    Connect(ID_MENUITEM14,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsValue4));
    Connect(ID_MENUITEM15,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsValue5));
    Connect(ID_MENUITEM16,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsValue6));
    Connect(ID_MENUITEM17,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsValue7));
    Connect(ID_MENUITEM18,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsValue8));
    Connect(ID_MENUITEM32,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsValueOther));
    Connect(ID_MENUITEM20,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsMul2));
    Connect(ID_MENUITEM21,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsMul3));
    Connect(ID_MENUITEM22,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsMul4));
    Connect(ID_MENUITEM23,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsMul5));
    Connect(ID_MENUITEM24,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsMul6));
    Connect(ID_MENUITEM25,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsMul7));
    Connect(ID_MENUITEM26,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsMul8));
    Connect(ID_MENUITEM27,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsMulOther));
    Connect(ID_MENUITEM29,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsPower2));
    Connect(ID_MENUITEM30,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsPower4));
    Connect(ID_MENUITEM31,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsPower8));
    Connect(ID_MENUITEM33,wxEVT_COMMAND_MENU_SELECTED,wxCommandEventHandler(HexEditPanel::OnSetColsPowerOther));
    //*)
