...
// ----------------------------------------------------------------------------
{
    ...
    if (!wxXmlResource::Get()->LoadPanel(panel, parent, wxT("dlgDebuggergdbmiOptions")))
        return panel;
    ...
    XRCCTRL(*panel, "chkUsePrettyPrinters", wxCheckBox)->SetValue(GetFlag(UsePrettyPrinters));
...
// ----------------------------------------------------------------------------
{
    ...
    m_config.Write(wxT("use_pretty_printers"),   XRCCTRL(*panel, "chkUsePrettyPrinters", wxCheckBox)->GetValue());
...
// ----------------------------------------------------------------------------
{
    switch (flag)
    {
        ...
        case UsePrettyPrinters:
            return m_config.ReadBool(wxT("use_pretty_printers"), false);
        case DoNotRun:
...
// ----------------------------------------------------------------------------
{
    switch (flag)
    {
        ...
        case AddOtherProjectDirs:
            ...
            break;
        case UsePrettyPrinters:
            m_config.Write(wxT("use_pretty_printers"), value);
            break;
        case DoNotRun:
