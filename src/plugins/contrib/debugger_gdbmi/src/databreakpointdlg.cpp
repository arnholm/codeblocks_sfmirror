 ...
 *
 * $Revision: 7960 $
 * $Id: databreakpointdlg.cpp 7960 2012-05-11 07:21:39Z mortenmacfly $
 * $HeadURL: https://svn.berlios.de/svnroot/repos/codeblocks/trunk/src/plugins/debugger_gdbmi/databreakpointdlg.cpp $
 */
...
DataBreakpointDlg::DataBreakpointDlg(wxWindow *parent, const wxString& dataExpression, bool enabled, int selection)
{
    ...
    bszMain->Add(m_enabled, 0, wxTOP|wxLEFT|wxRIGHT|wxEXPAND|wxALIGN_LEFT, 8);
    ...
    bszMain->Add(m_dataExpression, 1, wxTOP|wxLEFT|wxRIGHT|wxEXPAND|wxALIGN_LEFT, 8);
    ...
    bszMain->Add(m_condition, 0, wxTOP|wxLEFT|wxRIGHT|wxEXPAND|wxALIGN_LEFT, 8);
