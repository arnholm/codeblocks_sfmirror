 ...
 *
 * $Revision: 9231 $
 * $Id: debuggeroptionsprjdlg.cpp 9231 2013-07-25 18:58:24Z codeblocks $
...
// ----------------------------------------------------------------------------
    ...
    m_LastTargetSel(-1)
{
    if (not wxXmlResource::Get()->LoadPanel(this, parent, _T("pnlDebuggerProjectOptions")))
        return;
