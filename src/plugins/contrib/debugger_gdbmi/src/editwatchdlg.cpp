 ...
 *
 * $Revision: 8446 $
 * $Id: editwatchdlg.cpp 8446 2024-03-07 13:25:31 codeblocks $
 * $Id: editwatchdlg.cpp 8446 2024-03-07 13:25:31 codeblocks $
 * $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/debugger_gdbmi/editwatchdlg.cpp $
 */
...
//EditWatchDlg::EditWatchDlg(cb::shared_ptr<dbg_mi::Watch> w, wxWindow* parent)
EditWatchDlg::EditWatchDlg(dbg_mi::Watch::Pointer w, wxWindow* parent)
    : m_watch(w)
{
    //ctor
...
void EditWatchDlg::EndModal(int retCode)
{
    if (retCode == wxID_OK && m_watch)
    {
        ...
        m_watch->SetFormat((dbg_mi::WatchFormat)XRCCTRL(*this, "rbFormat", wxRadioBox)->GetSelection());
