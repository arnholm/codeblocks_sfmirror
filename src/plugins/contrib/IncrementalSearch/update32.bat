...
rem
rem $Revision: 7443 $
rem $Id: update.bat 7443 2011-09-01 16:32:16Z mortenmacfly $
...
copy .\*.png ..\..\..\devel32\share\CodeBlocks\images\settings\ > nul 2>&1
copy .\*.png ..\..\..\output32\share\CodeBlocks\images\settings\ > nul 2>&1
exit 0
