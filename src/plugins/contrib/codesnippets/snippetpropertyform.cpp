...
SnippetPropertyForm::SnippetPropertyForm( wxWindow* parent, int id, const wxString& title, const wxPoint& pos, const wxSize& size, int style ) : wxScrollingDialog( parent, id, title, pos, size, style )
{
	wxBoxSizer* sbSizer;
