...
void wxSpeedButton::GetGlyphSize(const wxBitmap &inGlyph, int &outWidth, int &outHeight) const
{
    if (inGlyph.Ok())
    {
...
void wxSpeedButton::ComputeBestSize()
{
    int         i,n;
    int         w,h;
    int         bn;
...
// border size is a magic number, empirically determined using the
...
wxSize wxSpeedButton::DoGetBestSize() const
{
    return mBestSize;
}
...
void wxSpeedButton::SetLabel(const wxString &inLabel)
{
    wxControl::SetLabel(inLabel);
    Refresh(false);
}
...
void wxSpeedButton::SetGlyphUp(const wxBitmap &inBitmap)
{
    mGlyphUp = inBitmap;
    Refresh(false);
}

const wxBitmap &wxSpeedButton::GetGlyphUp() const
{
    return mGlyphUp;
}
...
void wxSpeedButton::SetGlyphDown(const wxBitmap &inBitmap)
{
    mGlyphDown = inBitmap;
    Refresh(false);
}

const wxBitmap &wxSpeedButton::GetGlyphDown() const
{
    return mGlyphDown;
}
...
void wxSpeedButton::SetGlyphDisabled(const wxBitmap &inBitmap)
{
    mGlyphDisabled = inBitmap;
    Refresh(false);
}

const wxBitmap &wxSpeedButton::GetGlyphDisabled() const
{
...
int wxSpeedButton::GetAlign() const
{
    return GetWindowStyleFlag() & wxBU_ALIGN_MASK;
}
...
int wxSpeedButton::GetMargin() const
{
    return mMargin;
}
...
int wxSpeedButton::GetGroupIndex() const
{
    return mGroupIndex;
}
...
bool wxSpeedButton::GetDown() const
{
    return mButtonDown;
}
...
bool wxSpeedButton::GetValue() const
{
...
bool wxSpeedButton::GetAllowAllUp() const
{
...
long wxSpeedButton::GetUserData() const
{
