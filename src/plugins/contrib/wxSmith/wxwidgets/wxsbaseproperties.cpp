...
void wxsBaseProperties::OnEnumProperties(long _Flags)
{
    ...
    if ( (_Flags & flTopLevel)   && PSFilter           ) WXS_BOOL_PT        (wxsBaseProperties,m_Create,         _("Create the window"),                                                             _T("create_window"), true,         Priority2, _("Add Create() function. If disabled, you must add inherited class in constructor"));
