...
void wxsMenuEditor::CreateContent(wxWindow* parent)
{
    ...
    m_Content = new wxTreeCtrl(StaticBoxSizer1->GetStaticBox(), ID_TREECTRL1, wxDefaultPosition, wxSize(200,295), wxTR_HIDE_ROOT|wxTR_DEFAULT_STYLE, wxDefaultValidator, _T("ID_TREECTRL1"));
    ...
    m_TypeNormal = new wxRadioButton(StaticBoxSizer2->GetStaticBox(), ID_RADIOBUTTON1, _("Normal"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON1"));
    m_TypeNormal->SetValue(true);
    m_TypeNormal->Disable();
    GridSizer1->Add(m_TypeNormal, 1, wxLEFT|wxRIGHT|wxEXPAND, 4);
    m_TypeSeparator = new wxRadioButton(StaticBoxSizer2->GetStaticBox(), ID_RADIOBUTTON4, _("Separator"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON4"));
    m_TypeSeparator->Disable();
    GridSizer1->Add(m_TypeSeparator, 1, wxLEFT|wxRIGHT|wxEXPAND, 4);
    m_TypeCheck = new wxRadioButton(StaticBoxSizer2->GetStaticBox(), ID_RADIOBUTTON2, _("Check"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON2"));
    m_TypeCheck->Disable();
    GridSizer1->Add(m_TypeCheck, 1, wxLEFT|wxRIGHT|wxEXPAND, 4);
    m_TypeBreak = new wxRadioButton(StaticBoxSizer2->GetStaticBox(), ID_RADIOBUTTON5, _("Break"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON5"));
    m_TypeBreak->Disable();
    GridSizer1->Add(m_TypeBreak, 1, wxLEFT|wxRIGHT|wxEXPAND, 4);
    m_TypeRadio = new wxRadioButton(StaticBoxSizer2->GetStaticBox(), ID_RADIOBUTTON3, _("Radio"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON3"));
    m_TypeRadio->Disable();
    GridSizer1->Add(m_TypeRadio, 1, wxLEFT|wxRIGHT|wxEXPAND, 4);
    StaticBoxSizer2->Add(GridSizer1, 0, wxEXPAND, 10);
    StaticLine1 = new wxStaticLine(StaticBoxSizer2->GetStaticBox(), ID_STATICLINE1, wxDefaultPosition, wxSize(10,-1), wxLI_HORIZONTAL, _T("ID_STATICLINE1"));
    StaticBoxSizer2->Add(StaticLine1, 0, wxALL|wxEXPAND, 4);
    FlexGridSizer1 = new wxFlexGridSizer(0, 2, 0, 0);
    StaticText6 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), ID_STATICTEXT6, _("Id:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT6"));
    FlexGridSizer1->Add(StaticText6, 1, wxTOP|wxALIGN_CENTER_VERTICAL, 4);
    m_Id = new wxTextCtrl(StaticBoxSizer2->GetStaticBox(), ID_TEXTCTRL4, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL4"));
    m_Id->Disable();
    FlexGridSizer1->Add(m_Id, 1, wxTOP|wxLEFT|wxALIGN_CENTER_VERTICAL, 4);
    StaticText1 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), ID_STATICTEXT1, _("Label:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
    FlexGridSizer1->Add(StaticText1, 1, wxTOP|wxALIGN_CENTER_VERTICAL, 4);
    m_Label = new wxTextCtrl(StaticBoxSizer2->GetStaticBox(), ID_TEXTCTRL1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
    m_Label->Disable();
    FlexGridSizer1->Add(m_Label, 1, wxTOP|wxLEFT|wxALIGN_CENTER_VERTICAL, 4);
    StaticText2 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), ID_STATICTEXT2, _("Accelerator:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT2"));
    FlexGridSizer1->Add(StaticText2, 1, wxTOP|wxALIGN_CENTER_VERTICAL, 4);
    m_Accelerator = new wxTextCtrl(StaticBoxSizer2->GetStaticBox(), ID_TEXTCTRL2, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
    m_Accelerator->Disable();
    FlexGridSizer1->Add(m_Accelerator, 1, wxTOP|wxLEFT|wxALIGN_CENTER_VERTICAL, 4);
    StaticText3 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), ID_STATICTEXT3, _("Help:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT3"));
    FlexGridSizer1->Add(StaticText3, 1, wxTOP|wxALIGN_CENTER_VERTICAL, 4);
    m_Help = new wxTextCtrl(StaticBoxSizer2->GetStaticBox(), ID_TEXTCTRL3, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
    m_Help->Disable();
    FlexGridSizer1->Add(m_Help, 1, wxTOP|wxLEFT|wxALIGN_CENTER_VERTICAL, 4);
    StaticText4 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), ID_STATICTEXT4, _("Checked:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT4"));
    FlexGridSizer1->Add(StaticText4, 1, wxTOP|wxALIGN_CENTER_VERTICAL, 4);
    m_Checked = new wxCheckBox(StaticBoxSizer2->GetStaticBox(), ID_CHECKBOX1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
    m_Checked->SetValue(false);
    m_Checked->Disable();
    FlexGridSizer1->Add(m_Checked, 1, wxTOP|wxLEFT|wxEXPAND, 4);
    StaticText5 = new wxStaticText(StaticBoxSizer2->GetStaticBox(), ID_STATICTEXT5, _("Enabled:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT5"));
    FlexGridSizer1->Add(StaticText5, 1, wxTOP|wxALIGN_CENTER_VERTICAL, 4);
    m_Enabled = new wxCheckBox(StaticBoxSizer2->GetStaticBox(), ID_CHECKBOX2, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX2"));
    ...
    StaticLine2 = new wxStaticLine(StaticBoxSizer2->GetStaticBox(), ID_STATICLINE2, wxDefaultPosition, wxSize(10,-1), wxLI_HORIZONTAL, _T("ID_STATICLINE2"));
    StaticBoxSizer2->Add(StaticLine2, 0, wxALL|wxEXPAND, 4);
    BoxSizer2 = new wxBoxSizer(wxHORIZONTAL);
    BitmapButton1 = new wxBitmapButton(StaticBoxSizer2->GetStaticBox(), ID_BUTTON1, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_GO_BACK")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BUTTON1"));
    BoxSizer2->Add(BitmapButton1, 1, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 2);
    BitmapButton2 = new wxBitmapButton(StaticBoxSizer2->GetStaticBox(), ID_BUTTON2, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_GO_FORWARD")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BUTTON2"));
    BoxSizer2->Add(BitmapButton2, 1, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 2);
    BitmapButton3 = new wxBitmapButton(StaticBoxSizer2->GetStaticBox(), ID_BUTTON3, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_GO_UP")),wxART_MENU), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BUTTON3"));
    BoxSizer2->Add(BitmapButton3, 1, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 2);
    BitmapButton4 = new wxBitmapButton(StaticBoxSizer2->GetStaticBox(), ID_BUTTON4, wxArtProvider::GetBitmap(wxART_MAKE_ART_ID_FROM_STR(_T("wxART_GO_DOWN")),wxART_BUTTON), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BUTTON4"));
    BoxSizer2->Add(BitmapButton4, 1, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 2);
    StaticBoxSizer2->Add(BoxSizer2, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 2);
    BoxSizer3 = new wxBoxSizer(wxHORIZONTAL);
    Button5 = new wxButton(StaticBoxSizer2->GetStaticBox(), ID_BUTTON5, _("New"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT, wxDefaultValidator, _T("ID_BUTTON5"));
    BoxSizer3->Add(Button5, 1, wxRIGHT|wxEXPAND, 4);
    Button6 = new wxButton(StaticBoxSizer2->GetStaticBox(), ID_BUTTON6, _("Delete"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT, wxDefaultValidator, _T("ID_BUTTON6"));
