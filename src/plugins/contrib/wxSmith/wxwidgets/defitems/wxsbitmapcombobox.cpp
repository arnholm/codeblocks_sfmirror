...
wxObject* wxsBitmapComboBox::OnBuildPreview(wxWindow* Parent,long _Flags)
{
  int               i,n;
...
// done
  ...
  return SetupWindow(combo, _Flags);
}

//------------------------------------------------------------------------------

void wxsBitmapComboBox::OnEnumWidgetProperties(cb_unused long _Flags)
{
