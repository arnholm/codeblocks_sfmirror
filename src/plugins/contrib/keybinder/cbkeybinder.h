...
//          2.0.18 23/03/8
//          Refactor clKeyboardManager for simplicity and clarity
//          Save .conf file at app shutdown to fix missing user globals after debugging
//              with same personality and having changed the key bindings during debugging.
//          2.0.18 23/03/4
//          Release() clKeyboardManager at app shutdown which also saves the key binds
//          Remove redundant calls to Save() in clKeyboardManager::Initialize()
// ----------------------------------------------------------------------------
